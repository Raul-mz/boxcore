...
Sample URL:  http://gd2.mlb.com/components/game/mlb/year_2008/month_05/day_18/gid_2008_05_18_pitmlb_chnmlb_1/inning/inning_1.xml
'''
def fetchInning(year, month, day, gid, inning):
  url = "http://gd2.mlb.com/components/game/mlb/year_"+year+"/month_"+month+"/day_"+day+"/gid_"+gid+"/inning/inning_"+str(inning)+".xml"
  url = url.encode("utf-8")
  #logging.info(url)
  headers = { 'Host': 'gd2.mlb.com', 'Content-Type': 'text/xml', 'Accept': 'text/xml' }
  result = urlfetch.fetch(url, headers=headers)
